...
if __name__ == "__main__":
    input_file = os.path.join(project_root, 'data/processed/lipophilicity_cleaned.csv')
    output_file = os.path.join(project_root, 'data/processed/lipophilicity_features.csv')
