...
def build_features(input_path, output_path, target_col):
    logger.info(f"Building Tox features from {input_path}")
...
if __name__ == "__main__":
    # ClinTox
    build_features(
        os.path.join(project_root, 'data/processed/clintox_cleaned.csv'),
        os.path.join(project_root, 'data/processed/clintox_features.csv'),
        target_col='ClinTox'
    )
    # hERG
    build_features(
        os.path.join(project_root, 'data/processed/herg_cleaned.csv'),
        os.path.join(project_root, 'data/processed/herg_features.csv'),
        target_col='hERG'
    )
